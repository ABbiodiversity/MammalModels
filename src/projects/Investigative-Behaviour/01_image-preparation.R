...
# NOTE:        This was done in October 2022, before the WildTrax reports contained the image URL links.
#              This was to support a 3rd round of tagging done by Cassie S.
...
df_links <- read_csv(paste0(root, "data/supplemental/assumptions-tests/investigation-behaviour-by-veghf/data/image_links_from_wt.csv"))
...
write_csv(sample, paste0(root, "data/supplemental/assumptions-tests/investigation-behaviour-by-veghf/data/sample-for-tagging-2022.csv"))
