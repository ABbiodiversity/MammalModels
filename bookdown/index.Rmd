...
The Alberta Biodiversity Monitoring Institute (ABMI) has developed a monitoring program for mammals within Alberta, Canada. This technical document contains information describing how the image data from remote camera traps deployed across the province is collected, processed, and analyzed. 
